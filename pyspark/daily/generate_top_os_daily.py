...
def generate_top_os_daily(process_date, input_path, output_path):
    spark = SparkSession.builder \
        .appName(f"ToposDaily_for_{process_date}") \
...
if __name__ == "__main__":
    ...
    generate_top_os_daily(args.process_date, args.input_path, args.output_path)