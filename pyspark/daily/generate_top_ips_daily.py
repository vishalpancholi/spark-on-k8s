...
def generate_top_ips_daily(process_date, input_path, output_path):
    spark = SparkSession.builder \
        .appName(f"TopIPsDaily_for_{process_date}") \
    ...
    print(f"Generated top_ips_daily for {process_date}")
    spark.stop()
...
if __name__ == "__main__":
    ...
    generate_top_ips_daily(args.process_date, args.input_path, args.output_path)